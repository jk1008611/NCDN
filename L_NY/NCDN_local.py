...
def NCDN(x, cn, istraining):
    ...
    x_2_3 = layer['Cap_1_5'] = Layers.denselayercap(x_2_2, num_layer, x_2_2.shape[-1].value, stddev, 3, kprob, training,
                                                    "d1")

    x_1_13 = layer['transup_1_2'] = Layers.transuplayer(x_1_12,

                                                        [3, 3, x_1_12.shape[-1].value, int(x_1_12.shape[-1].value)],
                                                        stddev,

                                                        x_2_2, [1, 2, 2, 1], 'transup_1_2')

    x_2_4 = layer['conv_2_1'] = Layers.convlayer(x_2_3,

                                                 [3, 3, x_2_3.shape[-1].value, int(x_2_3.shape[-1].value)],
                                                 [int(x_2_3.shape[-1].value)], stddev, 'conv_2_1')

    x_1_14 = layer['concat_1_4'] = Layers.concatlayer(x_1_13, x_2_2)
    ...
    x_3_2 = layer['conv_3_1'] = Layers.convlayer(x_3_1,

                                                 [3, 3, x_3_1.shape[-1].value, int(x_3_1.shape[-1].value / 2)],
                                                 [int(x_3_1.shape[-1].value / 2)], stddev, 'conv_3_1')

    x_3_3 = layer['conv_3_2'] = Layers.convlayer(x_3_2,

                                                 [3, 3, x_3_2.shape[-1].value, int(x_3_2.shape[-1].value / 2)],
                                                 [int(x_3_2.shape[-1].value / 2)], stddev, 'conv_3_2')

    x_3_4 = layer['conv_3_3'] = Layers.convlayer(x_3_3,

                                                 [3, 3, x_3_3.shape[-1].value, cn], [cn], stddev, 'conv_3_3')
